...
* Entidad Product - representa un producto en el sistema

*

* Esta clase define la estructura de datos de un producto

* y su mapeo a la base de datos usando JPA annotations.
